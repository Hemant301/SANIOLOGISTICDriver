                  ...
                  child: Padding(
                      ...
                      child: Column(
                          ...
                          children: [
                            profileitem(
                              title: "User Type",
                              disc: "${getProfileData['user_type'] ?? "N/A"}",
                            ),
                            profileitem(
                              title: "Vehicle",
                              disc: "JH17426",
                            ...
                            profileitem(
                              title: "Aadhar No",
                              disc: "${getProfileData['aadhar_no'] ?? "N/A"}",
                            ),
                            ...
                            profileitem(
                              title: "Address",
                              disc:
                                  "${"${getProfileData['address']}" + " " + "${getProfileData['city']}" + " " + "${getProfileData['state']}" ?? "N/A"}",
                            ),
                          ])))),
          Padding(
              padding: const EdgeInsets.all(15.0),
                ...
                child: Column(
                  children: [
                    ...
                    profileitem(
                      ...
                      disc: "${getProfileData['personal_insurance'] ?? "N/A"}",
                    ),
                    profileitem(
                      title: "Nominee",
