                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text("${assignList[index]['loadtype']}")
                                      ],
                                    ),
                                    const SizedBox(
                                      height: 10,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "${assignList[index]['schedule_date']}")
                                      ],
                                    ),
                                    const SizedBox(
                                      height: 10,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            "${assignList[index]['material_type']}")
                                      ],
                                    ),
                                    const SizedBox(
                                      height: 10,
